...
CREATE TABLE `teacher_class` (
  ...
  KEY `fk_teacher_class_class` (`class_id`),
  CONSTRAINT `fk_teacher_class_class` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`),
  CONSTRAINT `fk_teacher_class_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teachers` (`id`)
...
INSERT INTO `teacher_class` VALUES (1,1),(2,1),(5,1),(3,2),(4,2),(5,2);
